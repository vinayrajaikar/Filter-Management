...
const CreateFilter = () => {
  ...
  const onSubmit = (data: CreateFilterData) =>{
      ...
      <div className="bg-[#F7F9FB] w-full min-h-screen flex items-center justify-center ">
        <div className="w-30 w-140 h-230 m-10">
            <div className="flex items-center gap-3">
              ...
              <Plus className="w-6 h-6 text-white bg-blue-500 border rounded-md " />
            </div>
              ...
              <FormProvider {...methods}>
                <form onSubmit={methods.handleSubmit(onSubmit)} >
                  ...
                  <div className="flex items-center justify-center gap-20 mt-5 pb-10">
                    <button type="submit" className="border border-slate-400 rounded-md p-2 w-30 ">Cancel</button>
